...
// +----------------------------------------------------------------------+
//
//  $Id: Translate.php 123 2019-09-03 15:03:36Z munix9 $
//
// $Id
...
// this will be removed soon
    ...
    */
    function simpleTranslate( $string , $lang )
    {
        ...
        if( (is_array($this->_translated['strings']) && sizeof($this->_translated['strings'])>0) &&   // this checks if the DB content had been read already
            $this->_translated['destLanguage'] == $lang )   // for this language
        {
            if( is_array($this->_sourceStringIndexed) && sizeof($this->_sourceStringIndexed) == 0 )
            {
...
//              
                ...
                // AK substitude the nex both lines with isset construction to aviod php notices
                //$begin = $delimiters[0];
                //$end = $delimiters[1];
                (isset($delimiters[0]))?$begin = $delimiters[0]:$begin='';
                (isset($delimiters[1]))?$end = $delimiters[1]:$end='';
