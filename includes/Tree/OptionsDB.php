...
// +----------------------------------------------------------------------+
//
//  $Id: OptionsDB.php 123 2019-09-03 15:03:36Z munix9 $
//
// $Id
//
// Rev 1.3.2.2 : _connectDB			AK
// 		set parent_class_name to lower as it comes as DB_common ...
// 		Diefference between php4 and php5	
...
class Tree_OptionsDB extends Tree_Options
{
    ...
    */
    ...
    {  
        ...
        parent::__construct( $options );          // do options afterwards since it overrules
    }
    ...
    function _connectDB( $dsn )
    {
        ...
        {	
        	// AK : set parent_class_name to lower as it comes as DB_common ...	
