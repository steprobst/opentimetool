...
//  *** empty log message ***
//
//  Revision 1.4  2002/09/27 16:42:06  mccain
//  - added autoLink, experimental
//  - imgSrc also takes array of dirs as params now
//
...
// FIXXME make img src tags relative if desired
        ...
        if(is_array($images[1]) && sizeof($images[1]))
        {
            if( empty($this->_imgDirs) )  // get image dirs if we didnt yet, since this instance might be used multiple times
            {
