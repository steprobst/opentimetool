...
class Date_Calc
{
    ...
    {
        return(self::nextDayOfWeek($dow,$day="",$month="",$year="",$format="%Y%m%d",true));
    ...
    {
        return(self::prevDayOfWeek($dow,$day="",$month="",$year="",$format="%Y%m%d",true));
    ...
    */
    ...
    static function endOfWeek($day="",$month="",$year="",$format="%Y%m%d")
    {
        ...
        $last_dayOfWeek = (self::dateToDays($day,$month,$year)
