...
$Id: holiday.tpl 123 2019-09-03 15:03:36Z munix9 $
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="newData[startTask_id]" style="width:200px;">
                        {%tasksAsOptions($tasks,(isset($data['startTask_id'])?$data['startTask_id']:0))%}
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="newData[endTask_id]" style="width:200px;">
                        {%task_asOptions($endTasks,(isset($data['endTask_id'])?$data['endTask_id']:0))%}
                    </select>
                </td>
            </tr>
