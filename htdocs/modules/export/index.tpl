...
<center>
    ...
    {if( is_array($exportedFiles) && sizeof($exportedFiles) )}
...
<script>
    ...
    {if(!empty($_REQUEST['exportedId']) && is_numeric($_REQUEST['exportedId']))}
        document.downloadForm.id.value = {echo intval($_REQUEST['exportedId'])};
